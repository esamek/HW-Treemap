        ...
        function draw(element, width, height, data, labels, styles) {
            ...
            boxDrawer = function () {
                function drawbox(coordinates, label, newindex) {
                    ...
                    boxattr = isFunction(styles.box) ? styles.box(coordinates, newindex, box) : styles.box;
                    ...
                    labelattr = isFunction(styles.label) ? styles.label(coordinates, newindex, text, box) : styles.label;
